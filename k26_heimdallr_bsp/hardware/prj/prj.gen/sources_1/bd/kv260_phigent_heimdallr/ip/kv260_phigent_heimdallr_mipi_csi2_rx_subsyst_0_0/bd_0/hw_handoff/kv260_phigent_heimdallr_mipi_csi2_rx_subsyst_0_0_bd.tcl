...
################################################################
# This is a generated script based on design: bd_4a56
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CSI_EN_VC_SUPPORT {0} \
   CONFIG.CSI_FIXED_VC {0} \
   ...
   CONFIG.C_RCVE_DESKEW_SEQ {false} \
   CONFIG.C_SPRT_ISP_BRIDGE {false} \
   CONFIG.HP_IO_BANK_SELECTION {66} \
 ] $rx
  ...
  set_property -dict [ list \
   CONFIG.C_HS_LINE_RATE {896} \
   CONFIG.VFB_DATA_TYPE {YUV420_8bit} \
   CONFIG.VFB_EN_VCX {0} \
   CONFIG.VFB_FIFO_DEPTH {4096} \
   CONFIG.VFB_FILTER_VC {1} \
   CONFIG.VFB_OP_PIXELS {2} \
   CONFIG.VFB_TU_WIDTH {1} \
   CONFIG.VFB_VC {0} \
   CONFIG.VFB_WC_FIFO_DEPTH {4096} \
 ] $vfb_0
  ...
  connect_bd_net -net phy_rxbyteclkhs [get_bd_ports rxbyteclkhs] [get_bd_pins phy/rxbyteclkhs] [get_bd_pins rx/dl0_rxbyteclkhs] [get_bd_pins rx/dl1_rxbyteclkhs] [get_bd_pins rx/dl2_rxbyteclkhs] [get_bd_pins rx/dl3_rxbyteclkhs]
