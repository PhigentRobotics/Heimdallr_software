...
(* CORE_GENERATION_INFO="kv260_phigent_heimdallr_v_frmbuf_wr_0_1_v_frmbuf_wr,hls_ip_2021_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xck26-sfvc784-2LV-c,HLS_INPUT_CLOCK=3.333000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.433090,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=32,HLS_SYN_DSP=0,HLS_SYN_FF=4064,HLS_SYN_LUT=5581,HLS_VERSION=2021_1}" *)

module kv260_phigent_heimdallr_v_frmbuf_wr_0_1_v_frmbuf_wr (
...
wire   [5:0] empty_49_fu_182_p1;
reg   [5:0] empty_49_reg_212;
wire   [11:0] empty_fu_192_p1;
reg   [11:0] empty_reg_227;
wire    ap_CS_fsm_state2;
reg   [2:0] BYTES_PER_PIXEL_load_reg_233;
reg   [2:0] colorFormat_reg_238;
reg   [31:0] frm_buffer2_read_reg_243;
wire    ap_CS_fsm_state3;
reg   [31:0] frm_buffer_read_reg_248;
wire   [11:0] empty_50_fu_199_p1;
reg   [11:0] empty_50_reg_258;
wire   [14:0] WidthInBytes_fu_206_p2;
reg   [14:0] WidthInBytes_reg_263;
...
wire   [15:0] grp_FrmbufWrHlsDataFlow_fu_154_m_axi_mm_video_WSTRB;
...
wire   [31:0] zext_ln151_fu_186_p1;
wire   [11:0] WidthInBytes_fu_206_p0;
wire   [2:0] WidthInBytes_fu_206_p1;
reg   [4:0] ap_NS_fsm;
...
wire   [14:0] WidthInBytes_fu_206_p00;
wire   [14:0] WidthInBytes_fu_206_p10;
wire    ap_ce_reg;
...
kv260_phigent_heimdallr_v_frmbuf_wr_0_1_BYTES_PER_PIXEL #(
    .DataWidth( 3 ),
    .AddressRange( 40 ),
    .AddressWidth( 6 ))
BYTES_PER_PIXEL_U(
...
kv260_phigent_heimdallr_v_frmbuf_wr_0_1_MEMORY2LIVE #(
    .DataWidth( 3 ),
    .AddressRange( 40 ),
    .AddressWidth( 6 ))
MEMORY2LIVE_U(
...
kv260_phigent_heimdallr_v_frmbuf_wr_0_1_FrmbufWrHlsDataFlow grp_FrmbufWrHlsDataFlow_fu_154(
    ...
    .HwReg_frm_buffer(frm_buffer_read_reg_248),
    .HwReg_frm_buffer2(frm_buffer2_read_reg_243),
    .p_read(WidthInBytes_reg_263),
    .p_read1(colorFormat_reg_238),
    .p_read2(empty_reg_227),
    .p_read3(empty_50_reg_258),
    .p_read14(stride),
    .p_read25(empty_49_reg_212),
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
kv260_phigent_heimdallr_v_frmbuf_wr_0_1_CTRL_s_axi #(
...
kv260_phigent_heimdallr_v_frmbuf_wr_0_1_mm_video_m_axi #(
    .CONSERVATIVE( 1 ),
    .USER_DW( 128 ),
    .USER_AW( 32 ),
    .USER_MAXREQS( 105 ),
...
kv260_phigent_heimdallr_v_frmbuf_wr_0_1_mul_12ns_3ns_15_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 12 ),
    .din1_WIDTH( 3 ),
    .dout_WIDTH( 15 ))
mul_12ns_3ns_15_1_1_U134(
    .din0(WidthInBytes_fu_206_p0),
    .din1(WidthInBytes_fu_206_p1),
    .dout(WidthInBytes_fu_206_p2)
);

kv260_phigent_heimdallr_v_frmbuf_wr_0_1_regslice_both #(
    .DataWidth( 48 ))
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state4) | ((ap_sync_grp_FrmbufWrHlsDataFlow_fu_154_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state5)))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        BYTES_PER_PIXEL_load_reg_233 <= BYTES_PER_PIXEL_q0;
        colorFormat_reg_238 <= MEMORY2LIVE_q0;
        empty_reg_227 <= empty_fu_192_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        WidthInBytes_reg_263 <= WidthInBytes_fu_206_p2;
        empty_50_reg_258 <= empty_50_fu_199_p1;
        frm_buffer2_read_reg_243 <= frm_buffer2;
        frm_buffer_read_reg_248 <= frm_buffer;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        empty_49_reg_212 <= empty_49_fu_182_p1;
    end
end
...
assign BYTES_PER_PIXEL_address0 = zext_ln151_fu_186_p1;

assign MEMORY2LIVE_address0 = zext_ln151_fu_186_p1;

assign WidthInBytes_fu_206_p0 = WidthInBytes_fu_206_p00;

assign WidthInBytes_fu_206_p00 = empty_reg_227;

assign WidthInBytes_fu_206_p1 = WidthInBytes_fu_206_p10;

assign WidthInBytes_fu_206_p10 = BYTES_PER_PIXEL_load_reg_233;
...
always @ (*) begin
    ap_block_state5_on_subcall_done = ((ap_sync_grp_FrmbufWrHlsDataFlow_fu_154_ap_ready & ap_sync_grp_FrmbufWrHlsDataFlow_fu_154_ap_done) == 1'b0);
end
...
assign empty_49_fu_182_p1 = video_format[5:0];

assign empty_50_fu_199_p1 = height[11:0];

assign empty_fu_192_p1 = width[11:0];
...
assign zext_ln151_fu_186_p1 = video_format;


// synthesis translate_off
`include "kv260_phigent_heimdallr_v_frmbuf_wr_0_1_hls_deadlock_detector.vh"
`include "kv260_phigent_heimdallr_v_frmbuf_wr_0_1_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //kv260_phigent_heimdallr_v_frmbuf_wr_0_1_v_frmbuf_wr
